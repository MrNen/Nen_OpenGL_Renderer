...
struct basic_meta_sequence_container_traits {
   ...
   */
  [[nodiscard]] static iterator insert(const meta_ctx &area,
	...
	if constexpr (fixed_size) {
	  ...
	  return {area, static_cast<Type *>(container)->insert(
		  ...
		  value ? *static_cast<const typename Type::value_type *>(value) : *static_cast<const std::remove_reference_t<
			  typename Type::const_reference> *>(cref))};
	}
  }
   ...
   */
  [[nodiscard]] static iterator erase(const meta_ctx &area,
									  [[maybe_unused]] void *container,
									  [[maybe_unused]] const iterator &it) {
	if constexpr (fixed_size) {
	  return iterator{area};
	  ...
	  auto *const non_const = any_cast<typename Type::iterator>(&it.base());
	  return {area, static_cast<Type *>(container)->erase(non_const ? *non_const
																	: any_cast<const typename Type::const_iterator &>(it.base()))};
	}
  }
};
...
struct basic_meta_associative_container_traits {
  ...
  [[nodiscard]] static bool insert(void *container, const void *key, [[maybe_unused]] const void *value) {
	if constexpr (key_only) {
	  ...
	  return static_cast<Type *>(container)->emplace(*static_cast<const typename Type::key_type *>(key),
													 *static_cast<const typename Type::mapped_type *>(value)).second;
	}
  }
  ...
  static iterator find(const meta_ctx &area, void *container, const void *as_const, const void *key) {
	return container ? iterator{area, std::bool_constant<key_only>{},
